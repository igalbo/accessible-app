  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {!currentScanId ? (
        <>
          ...
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              ...
              2.1 AA reports and fix suggestions for your website. Start with a
              free scan.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground">
                  Get actionable insights with severity levels and fix
                  suggestions
                </p>
              </div>
              <div className="p-6">
                ...
                <p className="text-muted-foreground">
                  Get your accessibility score and issues report in under 60
                  seconds
                </p>
              </div>
            </div>
        ...
        <ScanResults scanId={currentScanId} onNewScan={handleNewScan} />
      )}
    </div>
  );
}
